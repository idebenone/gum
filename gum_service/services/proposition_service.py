...
async def process_observation_batch(
    ...
    try:
        ...
        await session.flush()
        print(f"Inserted {len(inserted_observations)} observations into DB")

        print("Starting proposition generation via LLM...")
        ...
        print(f"Generated {len(proposition_pool)} propositions from LLM")
        ...
        print("Applying proposition updates...")
