...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in gum_service_pb2_grpc.py depends on'
...
def add_ObservationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'AddObservations': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=gum__service__pb2.AddObservationsRequest.FromString,
                    response_serializer=gum__service__pb2.AddObservationsResponse.SerializeToString,
            ),
    }
